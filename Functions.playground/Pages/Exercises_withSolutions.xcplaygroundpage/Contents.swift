...
//: __Exercise 1.__
//:
//:Earlier we used the method, remove(at:) to remove the first letter of a string. This method belongs to the String class. See if you can use this same method to remove the last letter of a string.
